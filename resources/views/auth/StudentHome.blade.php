...
@section('content')
    ...
    <div class="container-fluid px-md-4">
        <div class="row mt-5 mb-md-3 mx-md-3">
            <div class="col-12">
                <h2 class="fw-bold ms-md-4  welstd" id="text-color">Welcome
        ...
        <div class="row mb-5 mt-md-3 mx-md-3">
            <div class="col-12 col-lg-9 msgsection">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1 overflow-hidden">
                                            <p class="text-uppercase fw-bold mb-0">
                                                <img src="{{ asset('assets/images/graduating-student 1.png') }}"
                                                    alt="" width="11%">
                                                Student
                                            </p>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                                    data-target="0">{{ !empty($students) ? $students->count() : '0' }}</span>
                                            </h4>
                                            <a href="{{ url('parent/students') }}"
                                                class="text-decoration-none text-muted">View all
                                                Student</a>
                                        </div>
                                        <div style="width: 16%;">
                            ...
                            <div class="card card-animate" style="background-color: rgb(162, 244, 10);">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                                    data-target="0">{{ !empty($bookingCount) ? $bookingCount->count() : '0' }}</span>
                                            </h4>
                                            <a href="{{ url('/bookings') }}" class="text-decoration-none text-muted">View
                                                all
                                                Tutotr</a>
                                        </div>
                            ...
                            <div class="card card-animate " style="background-color: rgb(162, 244, 10);">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                                    data-target="0">{{ !empty($tutors) ? $tutors->count() : '0' }}</span>
                                            </h4>
                                            <a href="{{ url('/bookings') }}" class="text-decoration-none text-muted">View
                                                all
                                                Booking</a>
                ...
                <div class="row mx-0 mb-5 mt-4 msgsection" style="border: 1px solid #dee2e6;">
                    <div class="col-12 d-flex justify-content-between pt-2 unreadm"
            ...
            <div class="col-12 col-md-6 col-lg-3">
                ...
                @else
                    <div class="row py-4">
                        <div class="col-12">
                            <div class="card h-100 align-items-center py-4 gap-2">
                                <img src="{{ url('assets/images/profile.png') }}" class="w-25 rounded-circle"
                                    alt="...">
                                <div class="card-body text-center">
                                    <h5 class="card-title">Need help? We’re here</h5>
                                    <p class="card-text">Speak to the London-based team. Our office is open 8am to 7pm
                                        Mon-Thurs, 8am to 5:30pm Fri.</p>
                                    <a href="tel:@isset($web_settings['Ph_num']) {{ $web_settings['Ph_num'] ?? '' }} @endisset"
                                        class="text-decoration-none mt-1">Contact us</a>
                                </div>
                            </div>
                        </div>
                    </div>
