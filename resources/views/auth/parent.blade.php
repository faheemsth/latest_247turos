        ...
        <div class="panel-group">
            <div class="row panel panel-primary">
                ...
                <form class="form-horizontal" id="registration-form">
                    @csrf
                    <input id="role_id" name="role_id" value="5" type="hidden">
                    <fieldset id="account">
                        <div class="panel-body mt-5 text-center">
                            <h2 class="text-center fs-1" id="text-color"><strong>Parent Information</strong>
                            </h2><br>
                        </div>
                        <div class="d-flex flex-column flex-md-row ">
                            <div class="col-md-12 col-12 ">
                                <div class="row mt-4 justify-content-center">
                                    <div class="col-md-5">
                                        <label class="text-secondary">Parent First Name<span
                                ...
                                <div class="row mt-4 justify-content-center">
                                    <div class="col-md-5">
                                        <label class="text-secondary">Parent Last Name<span
                                                style="color: red;">*</span></label><br>
                                ...
                                <div class="row mt-4 justify-content-center">
                                    <div class="col-md-5">
                                        <label class="text-secondary">Parent Email<span
                                                style="color: red;">*</span></label><br>
                                ...
                                <div class="row mt-4 justify-content-center">
                                    <div class="col-md-5">
                                        <label class="text-secondary">Parent Phone <span
                                                style="color: red;">*</span></label><br>
                                        <span class="d-flex">
                    ...
                    <fieldset id="personal">
                        <div class="panel-body mt-5">
                            <div class="container">
                                <h2 class="text-center fs-1" id="text-color"><strong>Your Student Details</strong>
                                </h2><br>
                                <div class="d-flex flex-column flex-md-row ">
                                    <div class="col-md-12 col-12 ">
                                        <div class="row mt-4 justify-content-center">
                                            <div class="col-md-5">
                                                <label class="text-secondary">Student First Name<span
                                                        style="color: red;">*</span></label><br>
                                        ...
                                        <div class="row mt-4 justify-content-center">
                                            <div class="col-md-5">
                                                <label class="text-secondary">Student Last Name<span
                                                        style="color: red;">*</span></label><br>
                                        ...
                                        <div class="row mt-4 justify-content-center">
                                            <div class="col-md-5">
                                                <label class="text-secondary">Date Of Birth<span
                                                        style="color: red;">*</span></label><br>
                                        ...
                                        <div class="row mt-4 justify-content-center">
                                            <div class="col-md-5">
                                                <label class="text-secondary">Student Email<span
                                                        style="color: red;">*</span></label><br>
                                        ...
                                        <div class="row mt-4 justify-content-center">
                                            <div class="col-md-5">
                                                <label class="text-secondary">Student Phone<span
                                                        style="color: red;">*</span></label><br>
                                                <span class="d-flex">
                                                    ...
                                                    <input type="text" id="phone" name="stuphone"
                        ...
                        <div class="panel-body mt-5">
                            ...
                            <div class="d-flex flex-column flex-md-row ">
                                ...
                                <div class="col-12 col-md-12 col-lg-12 col-xl-12 m-auto">
                                    ...
                                    <div class="row mt-4 justify-content-center">
                                        <div class="col-md-5">
                                            <label class="text-secondary mb-1" style="font-size: 1.6rem;">Subjects<span
                                                    style="color: red;">*</span></label><br>
                                            <span class="d-flex">
                                                @if (!empty($subjects))
                                ...
                                <div class="col-md-12 col-12 ">
                                    ...
                                    <div class="row mt-4 justify-content-center">
                                        <div class="col-md-5">
                                            ...
                                            <input type="password" id="parentpassword" name="password"
