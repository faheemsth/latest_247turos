...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <!-- end message area-->
            <div class="col-md-12 col-12   user-table-data">
                <div class="card p-3">
                    <div class="card-header justify-content-between">
                        <h3>{{ __('Parents Reviews') }}</h3>
                    </div>
                    <div class="card-body" style="overflow:scroll;">
                        ...
                        <table id="reviewStudents" class="table table-bordered">
                            ...
                            <tbody>
                                @forelse($reviewParents as $Parent)
                                 @if(!empty($Parent->parent))
                                    <tr>
                                        <td style="border-bottom: .5px solid black;">{{ $Parent->uuid }}</td>
                                        <td style="border-bottom: .5px solid black;">{{ optional($Parent->parent)->username }}</td>
                                        <td style="border-bottom: .5px solid black;">
                                            @for ($i=0;$i < $Parent->parent_rating ;$i++)
