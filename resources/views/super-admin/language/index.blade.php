...
@section('content')
            ...
            <div class="col-md-12  user-table-data col-12 pe-0 pe-md-2 ">
                <div class="card p-md-3 p-2">
                    <div class="card-header justify-content-between">
                        <h3>{{ __('Languages') }}</h3>
                        <div class="btn btn-primary px-1 py-1" data-bs-toggle="modal" data-bs-target="#addSubjectModal"
                            style="height: max-content;">
                            <a class="text-light"><i class="fa-solid fa-plus m-auto px-1"></i></a>
                        </div>
                    </div>
    ...
    <div class="modal" id="updateSubjectModal">
        <div class="modal-dialog">
            <div class="modal-content" id="Languagemodalget">
    ...
    <div class="modal" id="addSubjectModal">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ url('language/store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
    ...
    <script>
        function UpdateSubject(id, name, level) {
            ...
            const url = `{{ url('/language/update') }}/${id}`;
