<?php
$tutors = App\Models\Chat::where('reciver_id', Auth::id())->select('sender_id')->groupBy('sender_id')->with('sender')->get();
$countmessg = App\Models\Chat::where('reciver_id', Auth::id())->where('status', 0)->select('sender_id')->groupBy('sender_id')->with('sender')->get();
    ...
    <div class="container-fluid logo-img">
        ...
        <div class="dropdown dropdown-toggle d-lg-none">
            <a class="btn fw-bold dropdown dropdown-first p-1" href="#" role="button" id="dropdownMenuLink"
                ...
                <span class="name-logo px-2 fw-bold" style="color: rgba(13, 153, 255, 1);">{{ Auth::user()->username }}
                </span>
                <img src="{{ asset(Auth::user()->image ?? 'assets\images\default.png') }}" alt=""
                    style="width: 30px;height: 30px; border-radius: 50%;">
            </a>
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink">
                @if (Auth::user()->role_id === 6 && Auth::user()->status === 'Pending')
                    <li><a class="dropdown-item" href="{{ url('logout') }}"><img
                                src="{{ asset('assets/images/logout 1.png') }}" alt="" srcset="">
                            Logout</a></li>
                @else
                    ...
                    <li><a class="dropdown-item" href="{{ url('organization/students') }}">
                            <img src="{{ asset('assets/images/student 1.png') }}" alt="" srcset="">
                            Your Students</a></li>
                    <li><a class="dropdown-item" href="{{ url('/organization/payments') }}">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav m-auto mb-2 mb-lg-0 fw-bold">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/organization/payments') }}">Balance over view Report</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('findTutor') ? 'active' : '' }}"
                        href="{{ url('organization/messages') }}">Messages <span id="msgcount" class="messgcount"
            ...
            <div class="col-md-2 d-flex justify-content-end align-items-center header-btn gap-1"
                ...
                <div class="dropdown  d-none d-lg-flex ">
                    <a class="btn   fw-bold dropdown dropdown-second " href="#" role="button"
                        ...
                        @else
                            <span class="name-logo px-2 fw-bold text-capitalize"
                                style="color: rgba(13, 153, 255, 1);">{{ Auth::user()->first_name .' '.Auth::user()->last_name }}
                            </span>
                        @endif
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink">
                        ...
                        @else
                            <li><a class="dropdown-item"
                                    ...
                                    Profile</a></li>
                            <li><a class="dropdown-item" href="{{ url('organization/students') }}">
                                    <img src="{{ asset('assets/images/student 1.png') }}" alt=""
                                        srcset="">
                                    Your Students</a></li>
                            <li><a class="dropdown-item" href="{{ url('/organization/payments') }}">
                                    <i class="fa-solid fa-file-invoice-dollar me-2"></i>
                                    Billing & Payments</a></li>
                            <li><a class="dropdown-item" href="{{ url('complaint') }}"><i
