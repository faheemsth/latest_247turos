...
<div class="second-rotate d-none d-lg-block">
    <a href='{{route('tutorApplySteps')}}' class="btn fw-bold" id="btn-bg">Register as a Tutor</a>
    <a href='{{route('studentApplySteps')}}' class="btn fw-bold" id="btn-bg">Register as a Student</a>
</div>
@endif
  <!-- Rotate Div Sec end -->
