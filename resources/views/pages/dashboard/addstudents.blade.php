    ...
    <div class="container-fluid pb-5">
        <div class="container pb-5">
            <div class=" my-5 pt-md-5 pt-0">
                ...
                <div class="row">
                    <div class="col-12 p-4 custom-table"
                        style="border: 1px solid rgb(214, 214, 214);background-color: white;">
                        ...
                        <table class="table table-bordered border-dark mt-4 custom-table">
                            <thead class="qualification" id="qualification">
                                <tr>
                                    ...
                                    <th scope="">Email</th>
                                    <th scope="">Authorize Students</th>
                                    <th scope="">Status</th>
                                ...
                                @if (!empty($students))
                                    @foreach ($students as $student)
                                        <tr>
                                            ...
                                            <td>{{ $student->email }}</td>
                                            <td>
                                                {{-- <a href="javascript::void(0)" onclick="UpdateUser('{{ $student->id }}')"
                                                    class="btn btn-success">Update</a> --}}
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input form-check-lg" onclick="UpdateUser('{{ $student->id }}')" type="checkbox" id="flexSwitchCheckDefault" {{ $student->is_monitor == '1' ? 'checked' : '' }}>
                                                    </div>
                                            </td>
                                            <td>
                                            ...
                                            <td class="">
                                                <a href="{{ url('delete-student?id=') . $student->id }}"
                                                    class="btn qualification"><i class="fa-solid fa-trash"></i> Remove</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
                    ...
                    <div class="modal-content">
                        <form action="{{ url('add_student') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row mt-5">
                                    <div class="col-md-6">
                                        <input type="checkbox" name="is_monitor" value="on">
                                        <label for="exampleFormControlInput1" class="form-label">Authorize Students</label>
                                    </div>
                                </div>
                            </div>
