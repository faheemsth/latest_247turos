...
@endif
                    ...
                    <div class="row">
                        <div class="col-md-8 mx-auto">
                            <div class="card-body chat-care">
                                <div id="chat-part">
                                    <main>
                                        <header style="background-color: #d7d7d7;display: flex;align-items: center;border-radius: 5px">
                                            <img src="{{ url('').'/'.App\Models\User::find($id)->image }}"
                                                alt="" width="60" height="60">
                                            <div>
                                                <h2>Chat with
                                                    {{ App\Models\User::find($id)->first_name . ' ' . App\Models\User::find($id)->last_name }}
                                                </h2>
    ...
    <script>
        ...
        // window.Echo.channel('message').listen('NewTrade', (e) => {
        //     var sender = authenticatedUserId;
        //     var receiver = reciverUserId;

        //     if (sender == e.reciver_id && receiver == e.sender_id) {
        ...
        //         }
        //     } else if (sender == e.sender_id && receiver == e.reciver_id) {
