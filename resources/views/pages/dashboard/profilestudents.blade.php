    ...
    <div class="top-header p-2">
        <div class="container-fluid d-flex">
            <div class="col-md-6 contect-info">
                <a href="#"><img src="assets/images/email.svg"
                        alt="Email Icon"><span>hello@247tutors.co.uk</span></a>
                <span><a href="#"><img src="assets/images/phone.svg" alt="Phone Icon">
                        <span>+447851012039</span></a>
            </div>
            <div class="col-md-6 d-flex justify-content-end social-icon gap-2">
                <a href="https://www.twitter.com/"><img src="assets/images/twitter.svg" alt="Twitter icon"
                        width="25" height="auto"> </a>
                <a href="https://www.facebook.com/"><img src="assets/images/facebook.svg" alt="Facebook icon"
                        width="25" height="auto"> </a>
                <a href="https://www.linkedin.com/"><img src="assets/images/linkedin.svg" alt="Linedin icon"
                        width="25" height="auto"> </a>
                <a href="https://www.instagram.com/"><img src="assets/images/instagram.svg" alt="Instagram icon"
                        width="25" height="auto"> </a>
            </div>
        </div>
    </div>
                    ...
                    <div class="mt-3 arman">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-4 profile-img">
                                <img src="{{ url($student_profile->image) }}" alt="" class="img-fluid">
                            </div>
                            <div class="col-12 col-md-8 ps-lg-0 mt-1 ms-2 ms-md-0">
                                <div class="d-flex justify-content-between mt-lg-4 hr align-items-center">
                                    ...
                                    <h4>{{ $student_profile->first_name . ' ' . $student_profile->last_name }}<img
                        ...
                        <div class="mt-5">
                            <h3>About me:</h3>
                            {{-- <p>Hi! My name is {{ $student_profile->first_name . ' ' . $student_profile->last_name }} and I'm
                                currently a pre-medical student.</p>
                            <p> --}}

                                {{ $student_profile->profile_description }}
                            </p>
                        </div>
