...
<head>
    ...
    <!-- website title -->
    <title>Tutor apply step Page</title>
    <!-- Bootstrap Css file -->
    <link rel="stylesheet" href="./vendor/bootstrap/css/bootstrap.css">
    <!-- Style Css -->
    <link rel="stylesheet" href="./assets/css/style.css">
    <!-- font awesome icons -->
    <link rel="stylesheet" href="./assets/webicons/css/all.css">
    <!-- Slick slider CSS  -->
    <link rel="stylesheet" href="./vendor/slick/slick-style.css">
...
<body>
   ...
   <div class="first-rotate d-none d-lg-block">
    <a href="./Blog page.html" class="btn fw-bold" id="btn-bg">Blog</a>
    <a href="./faq.html" class="btn fw-bold" id="btn-bg">FAQS</a>
  </div>
  <div class="second-rotate d-none d-lg-block">
    <a href="./tutor-apply-step.html" class="btn fw-bold" id="btn-bg">Become a Tutor</a>
    <a href="./student-apply-step.html" class="btn fw-bold" id="btn-bg">Become a Student</a>
  </div>
  <!-- Rotate Div Sec end -->
  ...
  <div class="top-header p-2">
    <div class="container-fluid d-flex">
      <div class="col-md-6 contect-info">
        <a href="#"><img src="assets/images/email.svg" alt="Email Icon"><span>hello@247tutors.co.uk</span></a>
        <span><a href="#"><img src="assets/images/phone.svg" alt="Phone Icon"> <span>+447851012039</span></a>
      </div>
      <div class="col-md-6 d-flex justify-content-end social-icon gap-2">
        <a href="https://www.twitter.com/"><img src="assets/images/twitter.svg" alt="Twitter icon" width="25"
            height="auto"> </a>
        <a href="https://www.facebook.com/"><img src="assets/images/facebook.svg" alt="Facebook icon" width="25"
            height="auto"> </a>
        <a href="https://www.linkedin.com/"><img src="assets/images/linkedin.svg" alt="Linedin icon" width="25"
            height="auto"> </a>
        <a href="https://www.instagram.com/"><img src="assets/images/instagram.svg" alt="Instagram icon" width="25"
            height="auto"> </a>
      </div>
    </div>
  </div>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid logo-img">
      <a class="navbar-brand logo-247" href="./index.html"><img src="./assets/images/247 NEW Logo 1.png" alt=""
          srcset="" class="img-fluid"></a>
      <div class="d-flex align-items-center gap-md-4">
        <div class="dropdown d-lg-none  ">
          <a class="dropdown-toggle me-2 text-dark" href="#" role="button" id="dropdownMenuLink"
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav m-auto mb-2 mb-lg-0 fw-bold">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown"
              aria-expanded="false">How it's Work</a>
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <li><a class="dropdown-item" href="./organizaton.html">For Organization</a></li>
            </ul>
          </li>
          <li class="nav-item">
        ...
        <div class="col-md-2 d-flex justify-content-end align-items-center header-btn gap-1"
          ...
          <div class="dropdown d-none d-lg-inline-block ">
            <a class="dropdown-toggle me-2" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown"
              aria-expanded="false">
              <img src="assets/images/translation.svg" alt="Translation" width="20" height="auto">
            </a>
          ...
          <a href="./login-role.html" class="header-login px-3 py-2 mx-1 btn fw-bold" id="btn-bg"
            type="submit">Login</a>
          <div class="dropdown">
  ...
  <!-- Navbar-end  -->
           ...
           <!-- card 1 -->
             ...
             <div class="col-md-6 col-lg-3 my-2">
                <div class="car text-center">
                    ...
                    <div class="card-body">
                      <h6 class="card-title fw-bold fs-5" id="text-color">Add Students</h6>
             ...
             <div class="col-md-6 col-lg-3 my-2">
                <div class="car text-center">
                    ...
                    <div class="card-body">
                      <h5 class="card-title fw-bolder" id="text-color">Purchased Number of Hours</h5>
                      <p class="card-text">You can offer a free demo class to students to demonstrate your teaching skills. In addition, you will be able to timings during that class.</p>
                    </div>
                  </div>
             </div>
             <!-- card 4 -->
    ...
    <!--  apply step cards end -->

     <!-- footer section -->
   <div class="footer-wrapper container-fluid pt-4 mt-5">
    <!-- Top-Footer -->
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-7 pb-3">
                <img src="./assets/images/247 NEW Logo 2.png" alt="" srcset="" width="250px">
                <p class="py-3">
                ...
                <div>
                    <a href=""><img src="./assets/images/01.png" alt="" srcset=""></a>
                    <a href=""><img src="./assets/images/02.png" alt="" srcset=""></a>
                    <a href=""><img src="./assets/images/03.png" alt="" srcset=""></a>
                    <a href="">
                        <img src="./assets/images/Vector.png"
                            style="width: 44px; height: 44px; gap: 10px; padding: 14px; border-radius: 30px;"; id="bg-color" srcset="">
                    </a>
                    <a href=""><img src="./assets/images/05.png" alt="" srcset=""></a>
                </div>
                <div class="icon">
...
<!-- footer section end-->
    ...
    <!-- jquery file -->
    <script src="./vendor/jquery/jquery3.7.0.js"></script>
    <!-- Slick slider jquery  -->
    <script src="./vendor/slick/slick-slide.js"></script>
    <!-- main js file -->
