...
@section('content')
                                ...
                                <div class="container">
                                    <div class="col-md-5 center-box m-auto heih">
                                        <div class="box py-5">
                                            ...
                                            <h4 class="fw-bold my-4" style="color: rgba(0, 150, 255, 1)">Thank you for your
                                                application.</h4>
                                            <p>We are currently reviewing your application and will be in touch by email
                                                within
                                                7 working days to let you know about next steps. If you need any help,just
                                                get
                                                in touch.</p>
                                        </div>
                                        <div class="mt-1 mb-5">
                                            <p class="cen">Need help? Call us <a href="tel:+447851012039"
                                                    class="text-decoration-none"><span style="color: rgb(162, 244, 10)"> +44
                                                        7851 012039 </span></a> or<a href="mailto:hello@247tutors.co.uk"
                    ...
                    <div class="card card-animate" style="background-color: rgb(162, 244, 10);">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-4">
                                <div>
                                    <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                            data-target="0">{{ $Wallettotal }}</span></h4>
                                    <a href="{{ url('/tutor/payments') }}" class="text-decoration-none text-muted">View
                                        all
                                        Amount</a>
                                </div>
                                <div style="width: 16%;">
            ...
            <div class="popup-container" id="popupContainer">
                <div class="popup-content">
                    ...
                    <ul>
                        ...
                        <li>Est magni cupiditate ad laboriosam vitae a Dicta nisi qui corrupti laborum non repellat
                            molestiae.
                        </li>
                        <li>Lorem ipsum dolor sit amet.</li>
                        <li>Est magni cupiditate ad laboriosam vitae a Dicta nisi qui corrupti laborum non repellat
    ...
    @if (Auth::check() &&
            Auth::user()->role_id == 3 &&
            App\Models\TutorSubjectOffer::where('tutor_id', Auth::id())->where('fee', 0)->count() > 0)
        <script>
