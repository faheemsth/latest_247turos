...
<body style="background-color: #e9ecef;">
    <div class="preheader"
        ...
        Notification: Interview Scheduled for Tutor Position
    </div>
        ...
        <tr>
            ...
            <td align="center" bgcolor="#e9ecef">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 17px; line-height: 24px; ">
                            <p style="margin: 0;">Please ensure that you mark this date and time on your calendar. If there are any conflicts or if you require any accommodations for the interview, please let us know as soon as possible, and we will do our best to accommodate your needs.</p>
                        </td>
                    </tr>
                </table>
            </td>
