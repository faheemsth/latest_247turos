...
<div class="nav-item {{ $segment1 == 'complaint' ? 'active' : '' }}">
    <a class="d-flex align-items-baseline" href="{{ url('Complaintlogs') }}">
        <span class="fa-solid fa-box-tissue"
            style="color: rgb(50 50 50 / 94%);font-size: 15px ;padding-right:8.5px;"></span>{{ __('Complaint') }}</a>
</div>
<div class="nav-item  {{ $segment1 == 'transaction' ? 'active' : '' }}">
    <a class=" d-flex align-items-baseline" href="{{ url('/transaction') }}"><span class="fa-regular fa-credit-card"
            style="color: rgb(50 50 50 / 94%);font-size: 14px ;padding-right:8.5px;"></span>{{ __('Transaction') }}</a>
</div>
